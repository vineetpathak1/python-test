...
pearson_data.to_csv('pearson_running_study.csv', index=False)
...
spearman_data.to_csv('spearman_satisfaction.csv', index=False)
...
regression_data.to_csv('regression_study_scores.csv', index=False)
...
ttest_data.to_csv('ttest_independent.csv', index=False)
...
paired_data.to_csv('ttest_paired.csv', index=False)
...
anova_data.to_csv('anova_between.csv', index=False)
...
mannwhitney_data.to_csv('mannwhitney_test.csv', index=False)
...
wilcoxon_data.to_csv('wilcoxon_test.csv', index=False)
...
kruskal_data.to_csv('kruskal_test.csv', index=False)
...
measurements.to_csv('friedman_test.csv', index=False)

print("Sample data files have been created successfully!")
print("Additional sample data files have been created successfully!")